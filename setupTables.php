...
try {
	...
	$stmt = $pdo->query("DROP TABLE IF EXISTS `API`");
        ...
        $stmt = $pdo->query("CREATE TABLE `StatusData` (   `ID` int(11) NOT NULL AUTO_INCREMENT,   `DeviceID` varchar(10) DEFAULT NULL,   `Time` datetime DEFAULT NULL,   `Sensor` varchar(28) DEFAULT NULL,   `Temp` int(11) DEFAULT NULL,   `Hum` int(11) DEFAULT NULL,   `Dis` int(11) DEFAULT NULL,   `Owner` int(11) DEFAULT NULL,   `Group` int(11) DEFAULT NULL,   `Latitude` decimal(25,20) DEFAULT NULL,   `Longitude` decimal(25,20) DEFAULT NULL,   `NickName` varchar(255) DEFAULT NULL,   `LastReset` datetime DEFAULT NULL,   `gettingStatus` tinyint(4) NOT NULL DEFAULT '0',   `ServiceUser` int(11) DEFAULT NULL,   PRIMARY KEY (`ID`) ) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4");
        $stmt = $pdo->query("CREATE TABLE `Users` (   `ID` int(11) NOT NULL AUTO_INCREMENT,   `UserID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,   `Password` varchar(255) NOT NULL,   `Group` varchar(255) DEFAULT NULL,   `Name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,   `Service` tinyint(4) NOT NULL DEFAULT '0',   `mailAddress` varchar(255) NOT NULL DEFAULT '',   PRIMARY KEY (`ID`) ) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4");
