...
<html>
	...
	<div class="deviceAdd">
		...
		<div class="collection with-header settingList">
			...
			<a href="?step=1" class="collection-item grey-text text-darken-4 step-item" id="row_step1"> <i class="material-icons left">cloud</i>2. 位置情報の登録</a>
			
			<a href="?step=2" class="collection-item grey-text text-darken-4 step-item" id="row_step2"> <i class="material-icons left">swap_horiz</i>3. デバイス情報の登録</a>
			
			<div 			  class="collection-item grey-text text-darken-4 step-item" id="row_step3"> <i class="material-icons left">edit_location</i>4. 登録完了</div>
