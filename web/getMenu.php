	...
	<div class="deviceListBoard">
		...
		<?php
			...
			foreach($stmt as $data){
				...
				echo '<a class="waves-effect waves-light btn red" href="deleteMission.php?OrderID=' . htmlspecialchars($data['DeviceID'], ENT_QUOTES, 'UTF-8') . '"><i class="material-icons left">highlight_off</i>依頼取消</a>';
				echo '</div>';
				echo '</div></li>';
				$counter++;
			}
